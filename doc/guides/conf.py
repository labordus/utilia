# -*- coding: utf-8 -*-
#
# utilia documentation build configuration file, created by
...
_path_to_config = _join_path( sys.path[ 0 ], "utilia", "version.cfg" )
...
version = "{major}.{minor}".format( **_vinfo_numbers_DICT )
if   "bugfix" == _vinfo_release_type: # Stable Bugfix Release
    release = "{major}.{minor}.{bugfix}".format( **_vinfo_numbers_DICT )
elif "candidate" == _vinfo_release_type: # Release Candidate
    release = "{major}.{minor}.0rc{update}".format( **_vinfo_numbers_DICT )
elif "development" == _vinfo_release_type: # Development Release
    _vinfo_numbers_DICT[ "update" ] = \
    open( _join_path( sys.path[ 0 ], "utilia", "dev-timestamp.dat" ) ).read( 12 )
    release = "{major}.{minor}.0dev{update}".format( **_vinfo_numbers_DICT )
...
latex_documents = [
  ('index', 'utilia.tex', u'utilia Documentation',
...
man_pages = [
    ('index', 'utilia', u'utilia Documentation',
     [u'Eric A. McDonald'], 1)
]
...
texinfo_documents = [
  ('index', 'utilia', u'utilia Documentation',
   u'Eric A. McDonald', 'utilia', 'One line description of project.',
   'Miscellaneous'),
]
